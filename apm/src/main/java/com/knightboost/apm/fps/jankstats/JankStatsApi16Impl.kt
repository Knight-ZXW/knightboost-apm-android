...
internal open class JankStatsApi16Impl(
    ...
    private fun View.removeOnPreDrawListenerDelegate(delegate: OnFrameListenerDelegate) {
        setTag(R.id.apmMetricsDelegator, null)
        val delegator = getTag(R.id.apmMetricsDelegator) as DelegatingOnPreDrawListener?
    ...
    private fun View.getOrCreateOnPreDrawListenerDelegates():
        ...
        var delegator = getTag(R.id.apmMetricsDelegator) as DelegatingOnPreDrawListener?
        if (delegator == null) {
            ...
            setTag(R.id.apmMetricsDelegator, delegator)
        }
