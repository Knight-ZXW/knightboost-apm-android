...
import com.knightboost.apm.fps.jankstats.JankStatsApi22Impl
...
internal open class JankStatsApi24Impl(
    ...
    private fun Window.removeFrameMetricsListenerDelegate(
        ...
        val delegator = decorView.getTag(R.id.apmMetricsDelegator) as
        ...
        with(delegator?.delegates) {
            ...
            if (this?.size == 0) {
                ...
                decorView.setTag(R.id.apmMetricsDelegator, null)
            }
        }
    }
    ...
    private fun Window.getOrCreateFrameMetricsListenerDelegates():
        ...
        var delegator = decorView.getTag(R.id.apmMetricsDelegator) as
            DelegatingFrameMetricsListener?
        if (delegator == null) {
            ...
            decorView.setTag(R.id.apmMetricsDelegator, delegator)
        }
...
private class DelegatingFrameMetricsListener(
    ...
    override fun onFrameMetricsAvailable(
        ...
        try {
            val delegatesArray = delegates.toTypedArray()
...
//            ApmSafety.handleException("fpsTask","onFrameMetricsAvailableError",e)
        }
